...
**2.1. Printing a Detailed Mutual Debt Reconciliation Act:**
...
**2.2. Printing a Summary Mutual Debt Reconciliation Act:**
...
**2.3. Printing Reconciliation Acts for Multiple Partners in a Batch:**
...
**2.4. Printing the reconciliation report from a contact:**

You can also access the partner's general ledger directly from the Contacts module. In the Contacts module, select the required partner, go to their card, and select Print -> "Debt reconciliation statement" or "Currency debt reconciliation statement".
