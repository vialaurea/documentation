...
---------------------------------
Using the Via laurea Salary Calculation Module, there is an option to include amounts paid to individuals as suppliers, when forming the annual GPM312 declaration. To use this option, first select which ledger accounts need to be used for information for the declaration in the chart of accounts settings. You can do this at Accounting -> Configuration -> Chart of Accounts.

.. image:: GPM_312/img03.jpg
   :alt: Updating ledger accounts settings

When describing a physical person's contact in the Contacts module, it is necessary to note that this is an individual supplier, selecting the appropriate item as the license type (Personal Code, IDV number, etc.) and enter a specific number as the IDV number:

.. image:: GPM_312/img04.jpg
   :alt: Adding an employee as a supplier for GMP 312

When creating an invoice for this supplier, select the required activity code from the list in the GPM312 for L5 tag.

.. image:: GPM_312/img05.jpg
   :alt: Creating an invoice for the supplier
